<div class="pt-3 pb-3">
    <div class="row justify-content-center">
        <div class="row col-12 align-items-center">
            <div class="@if ($attachment->getCustomProperty('comment') != '') col-6 text-right @else col-12 text-center @endif">
                    ...
                    @if ($can_delete)
                        <div class="d-flex flex-column justify-content-center">
                            <button
                                ...
                                type="button"
                                class="d-block btn btn-sm btn-danger shadow-sm mb-1">
                            ...
                            <button
                                ...
                                type="button"
                                class="d-block btn btn-sm btn-primary shadow-sm mb-1">
            ...
            @if ($attachment->getCustomProperty('comment') != '')
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
