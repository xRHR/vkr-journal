            ...
            <div class="collapse show" id="collapseCardExample">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <label>Фамилия:</label>
                            <input type="text" class="form-control" name="lastname_genitive"
                                value="{{ $user->miscInfo->lastname_genitive }}">
                        </div>
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <label>Имя:</label>
                            <input type="text" class="form-control" name="firstname_genitive"
                                value="{{ $user->miscInfo->firstname_genitive }}">
                        </div>
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <label>Отчество:</label>
                            <input type="text" class="form-control" name="patronymic_genitive"
                                value="{{ $user->miscInfo->patronymic_genitive }}">
                        </div>
                    </div>
                </div>
            </div>
