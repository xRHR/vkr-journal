...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">{{ $user->lastname }} {{ $user->firstname }} @if($user->id == Auth::user()->id) (Вы) @elseif($user->professor_id == Auth::user()->id) (Ваш подопечный) @elseif($user->id == Auth::user()->professor_id) (Ваш руководитель) @endif</h1>
</div>
<div class="row">
