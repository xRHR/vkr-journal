...
```
cd existing_repo
git remote add origin https://gitlab.com/imibsu-vkr-journal/VKR-JOURNAL.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/imibsu-vkr-journal/VKR-JOURNAL/-/settings/integrations)
